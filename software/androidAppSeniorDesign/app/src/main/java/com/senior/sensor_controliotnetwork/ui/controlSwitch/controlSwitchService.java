...
//
//public class controlSwitchService extends Service {
//    private Looper serviceLooper;
//    private String threshold;
//    private Float thresholdFloat = 0.0f;
//    private ServiceHandler serviceHandler;
//    private DatabaseReference mPostReference;
////    private DatabaseReference mPostReferencecontrolSwitchThreshold;
...
//
//            try {
//                mPostReferencecontrolSwitchThreshold.setValue("0");
...
//
//                        send notification that the controlSwitch data is over the threshold value
...
////                };
//                //END CONSTANT LISTENER CODE//
////                mPostReferencecontrolSwitchThreshold.addValueEventListener(thresholdListener);
//
//
...
//        mPostReference = FirebaseDatabase.getInstance().getReference().child(userId).child("dataFromChild").child("controlSwitch");  //LISTENER OBJECT
////        mPostReferencecontrolSwitchThreshold = FirebaseDatabase.getInstance().getReference().child(userId).child("internalAppData").child("thresholds").child("controlSwitch");  //LISTENER OBJECT
//        HandlerThread thread = new HandlerThread("ServiceStartArguments",
//                Process.THREAD_PRIORITY_BACKGROUND);
//        thread.start();
//
//        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
////            NotificationChannel channel = new NotificationChannel("NotificationcontrolSwitchThreshold", "NotificationcontrolSwitchThreshold", NotificationManager.IMPORTANCE_DEFAULT);
...
//        Toast.makeText(this, "controlSwitch service starting", Toast.LENGTH_SHORT).show();
//
...
//
//
//        //mPostReference = FirebaseDatabase.getInstance().getReference().child(userId).child("dataFromChild").child("controlSwitchSensor");  //LISTENER OBJECT
...
//        Toast.makeText(this, "controlSwitch service done", Toast.LENGTH_SHORT).show();
//    }
//
...
//    }
//
//    public void sendNotification(String controlSwitchData){
//        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "NotificationcontrolSwitchThreshold");
//        builder.setContentTitle("controlSwitch Threshold Met");
//        String temp = String.format("%.2f", Float.parseFloat(thresholdMetValue));
//        builder.setContentText("Threshold Value: " + thresholdFloat + " controlSwitch Value: " + temp);
