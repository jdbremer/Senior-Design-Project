...
def my_callback(channel): #enters each time rising edge occurs
    global risingEdgeCount
...
GPIO.add_event_detect(25, GPIO.RISING, callback=my_callback) #detect rising edges
